## Ce script vise � effectuer l'ordonnancement de la capacité des vols
# 1) Packages
library(dplyr)
library(RPostgreSQL)
library(sqldf)
...
groups$timestamp_close <- Sys.time()+30*60 # changer �ventuellement pour une valeur retrouv�e dans la db
